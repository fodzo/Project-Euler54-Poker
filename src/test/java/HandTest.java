...
public class HandTest {
	...
	{
	    assertFalse(Hand.playerOneWins("5H 5C 6S 7S 2C 3S 8S 8D TD"));
	    assertTrue(Hand.playerOneWins("5D 8C 9S JS AC 2C 5C 7D 8S QH"));
	    assertFalse(Hand.playerOneWins("2D 9C AS AH AC 3D 6D 7D TD QD"));
	    assertTrue(Hand.playerOneWins("4D 6S 9H QH QC 3D 6D 7H QD QS"));
	    assertTrue(Hand.playerOneWins("2H 2D 4C 4D 4S 3C 3D 3S 9S 9D"));
	    assertFalse(Hand.playerOneWins("2H 2D 3C 3D 3S 3C 3D 3S 9S 9D"));
	    assertTrue(Hand.playerOneWins("TH TD 3C 3D 3S 3C 3D 3S 9S 9D"));
	    assertFalse(Hand.playerOneWins("3C 8C 2D 7D 4D 8S 7S 3H 2H 4D"));
	    assertTrue(Hand.playerOneWins("3C 8C 2D 7D 4D 8S 5S 3H 2H 4D"));
	    assertFalse(Hand.playerOneWins("3C 3H 3S 3D 4D 3S 3D 3H 3C TD"));
	    assertTrue(Hand.playerOneWins("3C 3H 3C 3D 4D 2S 2C 2H 2D TD"));
	    assertTrue(Hand.playerOneWins("3C 3H QS QD 3D 3S 3C QH QS 2D"));
	    assertFalse(Hand.playerOneWins("3C 3H TS TD 2D 3S 3H TS TH 4D"));
	    assertFalse(Hand.playerOneWins("3C 3H TS TD 2D 3S 3H KS KH 4D"));
	    assertTrue(Hand.playerOneWins("4C 4D TS TD 2D 3S 3H TS TH 4D"));
	    assertTrue(Hand.playerOneWins("4S 4C 4D TD 5D 4S 4C 4H TH 3D"));
	    assertTrue(Hand.playerOneWins("2H 3D 4C 5D 6S 4S 4C 4H TH 3D"));
	    assertTrue(Hand.playerOneWins("2H 3H 4H 5H 6H 4S 4C 4H TH 3D"));
	    assertTrue(Hand.playerOneWins("TH AH KH QH JH 4S 4C 4H TH 3D"));
